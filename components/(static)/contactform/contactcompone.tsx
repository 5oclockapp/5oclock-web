...
function ContactSection() {
  useEffect(() => {
    ...
    const el = document.querySelector(".scroll-blur-contact");
    if (el) observer.observe(el);

    return () => observer.disconnect();
  }, []);
  return (
    <div className="w-full bg-gradient-to-b from-black via-[#0a0014] to-[#040018]">
      <div className="scroll-blur-contact min-h-[50vh] sm:min-h-[60vh] text-white flex items-center justify-center py-10 px-6 sm:px-10 md:px-16 font-[Inter] relative overflow-hidden">
